...
export const prismaPrompt = () => {
    const output1 = readFileSync(`./src/lib/skeetai/prisma/examples/output1.txt`, 'utf-8');
    const output2 = String(readFileSync('./src/lib/skeetai/prisma/examples/output2.txt'));
    const prompt = {
        context: `
