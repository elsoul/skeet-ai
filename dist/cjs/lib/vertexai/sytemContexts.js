...
exports.promptTitleGenerationJa = exports.generateTitlePrompt = void 0;
const generateTitlePrompt = (content, isJapanese = false) => {
    const res = isJapanese
        ? (0, exports.promptTitleGenerationJa)(content)
        : {
...
exports.generateTitlePrompt = generateTitlePrompt;
...
exports.promptTitleGenerationJa = promptTitleGenerationJa;
//# sourceMappingURL=sytemContexts.js.map