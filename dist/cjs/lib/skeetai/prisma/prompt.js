...
const prismaPrompt = () => {
    const output1 = (0, fs_1.readFileSync)(`./src/lib/skeetai/prisma/examples/output1.txt`, 'utf-8');
    const output2 = String((0, fs_1.readFileSync)('./src/lib/skeetai/prisma/examples/output2.txt'));
    const prompt = {
        context: `
