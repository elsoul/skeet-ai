...
exports.jsonTranslatePrompt = exports.markdownTranslatePrompt = void 0;
const markdownTranslatePrompt = (langFrom = 'ja', langTo = 'en') => {
    return {
...
exports.markdownTranslatePrompt = markdownTranslatePrompt;
const jsonTranslatePrompt = (langFrom = 'ja', langTo = 'en') => {
    return {
...
exports.jsonTranslatePrompt = jsonTranslatePrompt;
