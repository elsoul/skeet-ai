...
exports.skeetPromptVertex = void 0;
const skeetPromptVertex = (content) => {
    return {
...
exports.skeetPromptVertex = skeetPromptVertex;
const examples = [
    {
        input: {
            content: 'Who created the Skeet framework?',
